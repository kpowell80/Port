...
function Philosophy() {
    return (
        <div className="about" id="philosophy">
             <h1>Philosophy.</h1>
             <h3>This is the decisive moment.</h3>
          <div className="phil">
            <Zoom>
            ...
            <Zoom>
             <h3 className="mission"> I am a problem solver. I will use my skills, experience and creativity to capture the design solutions needed, creating connections for the user.</h3>
             </Zoom>
           </div>
             </div>
    )
